...
from natgrad.domains import Hyperrectangle, HypercubeBoundary
...
print(f"STOKES with ITER={ITER}, LM={LM}")
...
x_Omega = interior.random_integration_points(random.PRNGKey(0), N=2000)
...
# (2,) -> (2,)
## here i think there was a mistake, i just use curl now to compute the true solution.
@jit
def u_star0(xyz):
    x = xyz[0]
    y = xyz[1]
